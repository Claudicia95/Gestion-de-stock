...
const ProductOverview = ({email} : {email : string}) => {
    const [stats , setStats] = useState<ProductOverviewStats | null>(null)
      ...
      const fetchStats = async () => {
        try {
          if (email) {
            const res = await getProductOverviewStats(email);
            if (res) {
              setStats(res);
            }
          }
                ...
                <div className='grid grid-cols-2 gap-4'>
                    ...
                    <div className='border-2 p-4 border-base-200 rounded-3xl'>
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <div className='bg-info/25 p-3 rounded-full'>
                                <Box className='w-5 h-5 text-error text-3xl' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='border-2 p-4 border-base-200 rounded-3xl'>
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <div className='bg-info/25 p-3 rounded-full'>
                                <Tag className='w-5 h-5 text-error text-3xl' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='border-2 p-4 border-base-200 rounded-3xl'>
                        ...
                        <div className='flex justify-between items-center'>
                            <div className='stat-value'>{formatNumber (stats.stockValue)} XFA</div>
                            <div className='bg-info/25 p-3 rounded-full'>
                                <DollarSign className='w-5 h-5 text-error text-3xl' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='border-2 p-4 border-base-200 rounded-3xl'>
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <div className='bg-info/25 p-3 rounded-full'>
                                <ShoppingCart className='w-5 h-5 text-error text-3xl' />
                            </div>
                        </div>
                    </div>
